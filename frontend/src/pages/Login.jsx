            ...
            <div className="flex flex-col gap-4">
              <div className="flex flex-col gap-1.5">
                ...
                <input
                  ...
                  className="p-4 rounded-2xl border border-gray-200 bg-gray-50 outline-none focus:border-rose-300 focus:bg-white focus:ring-2 focus:ring-rose-100 transition-all duration-200 font-sans text-sm text-gray-800 placeholder:text-gray-300"
                />
              </div>
